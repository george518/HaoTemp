...
<html>
    <head>
        <meta charset="utf-8">
        <link href="/Public/System/Base/css/public.css" type="text/css" rel="stylesheet">
        <link href="/Public/System/Base/css/houtai.css" type="text/css" rel="stylesheet">
        <link href="/Public/System/Base/css/smartMenu.css" type="text/css" rel="stylesheet">
    ...
    <body>
    	<div id="admin">
    		<div class="ad-menu" id="ad-menu">
                <div class="ad-logo"><img src="/Public/System/Base/image/m-logo.png" height="103" width="130"></div>
                <div class="ad-list">
                    <ul>
                        <li>
                            <div class="li-item"><em class="scm li-ico ic1"></em>模板示例<span class="scm arrow"></span></div>
                            <dl>
                                <dd>
                                    <a href="#" class="dd-item">列表页模板<span class="scm dd-ar"></span></a>
                                    <ul class="ad-item-list">
                                        <li class="J_menuItem" href="index_v1.html" data-index="1">通用列表</li>
                                ...
                                <dd>
                                    <a href="#" class="dd-item">系统高级搜索<span class="scm dd-ar"></span></a>
                                    <ul class="ad-item-list">
                        ...
                        <li>
                            <div class="li-item"><em class="scm li-ico ic2"></em>系统管理<span class="scm arrow"></span></div>
                            <dl>
                                <dd>
                                    <a href="#" class="dd-item">系统高级搜索<span class="scm dd-ar"></span></a>
                                </dd>
                        ...
                        <li>
                            ...
                            <dl>
                                <dd>
                                    <a href="#" class="dd-item">系统高级管理<span class="scm dd-ar"></span></a>
                                    <ul class="ad-item-list">
                                        <li class="J_menuItem" href="index_v1.html" data-index="1">测试用例一</li>
                                        <li class="J_menuItem" href="index_v2.html" data-index="2">测试用例二</li>
                                        <li class="J_menuItem" href="index_v3.html" data-index="3">测试用例三</li>
                                ...
                                <dd>
                                    <a href="#" class="dd-item">系统查询<span class="scm dd-ar"></span></a>
                                    <ul class="ad-item-list">
                                        <li class="J_menuItem" href="index_v1.html" data-index="1">测试用例一</li>
                                        <li class="J_menuItem" href="index_v2.html" data-index="2">测试用例二</li>
                                        <li class="J_menuItem" href="index_v3.html" data-index="3">测试用例三</li>
                                ...
                                <dd>
                                    <a href="#" class="dd-item">系统搜索<span class="scm dd-ar"></span></a>
                                    <ul class="ad-item-list">
                                        <li class="J_menuItem" href="index_v1.html" data-index="1">测试用例一</li>
                                        <li class="J_menuItem" href="index_v2.html" data-index="2">测试用例二</li>
                                        <li class="J_menuItem" href="index_v3.html" data-index="3">测试用例三</li>
                                ...
                                <dd>
                                    <a href="#" class="dd-item">系统高输入<span class="scm dd-ar"></span></a>
                                    <ul class="ad-item-list">
                                        <li class="J_menuItem" href="index_v1.html" data-index="1">测试用例一</li>
                                        <li class="J_menuItem" href="index_v2.html" data-index="2">测试用例二</li>
                                        <li class="J_menuItem" href="index_v3.html" data-index="3">测试用例三</li>
    		...
    		<div class="ad-comment-box" id="ad-comment">
                <div class="ad-top-comment">
                    <div class="ad-message">
                        ...
                        <div class="ad-top-right">
                            ...
                            <div class="ad-welcom">
                                <div class="ad-wel-img"><img src="/Public/System/Base/image/min_logo.png" height="36" width="36"></div>
                                <div class="ad-wel-text">
                                    <div class="font-wel">欢迎您！<strong>ADMIN</strong></div>
                    ...
                    <div class="ad-sub-nav-box content-tabs">
                        ...
                        <div class="ad-sub-wraper page-tabs J_menuTabs">
                            <ul class="ad-sub-list page-tabs-content">
                                <li class="active J_menuTab" data-id="<?php echo U('System/Template/index');?>">首页</li>
                            </ul>
                        </div>
                ...
                <div class="ad-main-comment J_mainContent" id="ad-iframe">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo U('System/Template/index');?>" frameborder="0" data-id="<?php echo U('System/Template/index');?>" seamless></iframe>
                </div>
    		</div>
    	</div>
        <script type="text/javascript" src="/Public/System/Base/js/jquery.min.js"></script>
        <script type="text/javascript" src="/Public/System/Base/js/contabs.js"></script>
        <script type="text/javascript" src="/Public/System/Base/js/maintabs.js"></script>
        <script type="text/javascript" src="/Public/System/Base/js/jquery-smartMenu-min.js"></script>
        <script type="text/javascript" src="/Public/System/Base/js/jquery.nicescroll.min.js"></script>
